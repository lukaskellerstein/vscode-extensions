...
export class SidePanelProvider implements vscode.WebviewViewProvider {
  public static readonly viewType = "lukas-extension-4.sidePanel";
      ...
      switch (data.type) {
        case "addCircleToEditor":
          ...
          if (editorProvider) {
            ...
            vscode.window.showWarningMessage("Luke Editor is not initialized");
          }
          break;
        case "colorSelected":
  ...
  private _getHtmlForWebview(webview: vscode.Webview) {
    const scriptUri = webview.asWebviewUri(
      vscode.Uri.file(path.join(this._extensionPath, "out", "webview", "sidebar", "index.js"))
    );
